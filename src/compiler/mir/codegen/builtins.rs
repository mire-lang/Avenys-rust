...
pub(crate) fn pal_extern_decls() -> Vec<String> {
    vec![
        ...
        "declare ptr @pal_fs_dirname(ptr)".to_string(),
        "declare ptr @pal_fs_filename(ptr)".to_string(),
        "declare ptr @pal_fs_filext(ptr)".to_string(),
        "declare ptr @pal_proc_run(ptr)".to_string(),
        "declare ptr @pal_proc_exec(ptr)".to_string(),
        "declare i64 @pal_proc_spawn(ptr)".to_string(),
        "declare i64 @pal_proc_waitpid(i64)".to_string(),
