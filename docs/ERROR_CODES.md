...
| E0005 | Type Error | Type mismatch in assignments, operator applications, function arguments, return values, or undefined identifiers | Review the declared types and assigned expressions; ensure operator operand types match |
...
| W0002 | Dead code | Unused | A function is defined but never called | Remove or use the function |

### Type (W0004–W0005, W0021)

| Code | Title | When it appears | How to fix |
|------|-------|-----------------|------------|
| W0004 | Type annotation unnecessary | Redundant explicit type that could be inferred | Remove the annotation |
| W0005 | Implicit return type | Function has no explicit return type annotation | Add explicit return type `: type` |
| W0021 | Type mismatch hint | Operation has mismatched but compatible types | Ensure types are compatible |

### Performance (W0007–W0009)

| Code | Title | When it appears | How to fix |
|------|-------|-----------------|------------|
| W0007 | Multiply by zero | Multiplying a value by literal zero | Review if multiplication by zero is intentional |
| W0008 | Divide by zero | Dividing a value by literal zero | Add zero check before division |
| W0009 | Modulo by zero | Computing modulo of a value by literal zero | Add zero check before modulo |

### Style (W0006, W0012–W0014, W0024, W0034–W0035, W0037)

| Code | Title | When it appears | How to fix |
|------|-------|-----------------|------------|
| W0006 | Empty function body | Function has empty body | Add statements to the function body |
...
| W0014 | Empty if branches | If statement has empty branches | Add statements or remove the empty if |
...
| W0035 | Non-idiomatic function name | Function name contains uppercase characters | Rename to snake_case |
...
### Clippy (W0041–W0047) — Opt-in only
...
### Logic (W0017, W0019, W0036, W0038, W0040)
...
| W0040 | Missing explicit return | Function declares return type but has no explicit return | Add an explicit `return` statement |
...
- Codes W0015, W0016, W0020, W0022, W0023, W0026–W0033 are reserved for future lint passes.
